...
export const MOCK_GALLERY = [
  G('g1',  'lpk_galeria_01.webp', 'Corte natural',          'Corte'),
  G('g2',  'lpk_galeria_02.webp', 'Balayage luminoso',      'Color'),
  G('g3',  'lpk_galeria_03.webp', 'Color vibrante',         'Color'),
  G('g4',  'lpk_galeria_04.webp', 'Tratamiento profundo',   'Tratamientos'),
  G('g5',  'lpk_galeria_05.webp', 'Corte moderno',          'Corte'),
  G('g6',  'lpk_galeria_06.webp', 'Mechas californianas',   'Color'),
  G('g7',  'lpk_galeria_07.webp', 'Corte y forma',          'Corte'),
  G('g8',  'lpk_galeria_08.webp', 'Alisado progresivo',     'Tratamientos'),
  G('g9',  'lpk_galeria_09.webp', 'Tonos caramelo',         'Color'),
  G('g10', 'lpk_galeria_10.webp', 'Corte en capas',         'Corte'),
  G('g11', 'lpk_galeria_11.webp', 'Color fantasía',         'Color'),
  G('g12', 'lpk_galeria_12.webp', 'Hidratación profunda',   'Tratamientos'),
  G('g13', 'lpk_galeria_13.webp', 'Corte bob',              'Corte'),
  G('g14', 'lpk_galeria_14.webp', 'Mechas rubias',          'Color'),
  G('g15', 'lpk_galeria_15.webp', 'Color oscuro',           'Color'),
  G('g16', 'lpk_galeria_16.webp', 'Nutrición capilar',      'Tratamientos'),
  G('g17', 'lpk_galeria_17.webp', 'Corte degradado',        'Corte'),
  G('g18', 'lpk_galeria_18.webp', 'Estilo natural',         'Corte'),
  G('g19', 'lpk_galeria_19.webp', 'Balayage natural',       'Color'),
  G('g20', 'lpk_galeria_20.webp', 'Tonalidades miel',       'Color'),
  G('g21', 'lpk_galeria_21.webp', 'Trabajo en color',       'Corte'),
  G('g22', 'lpk_galeria_22.webp', 'Resultado brillante',    'Color'),
  G('g23', 'lpk_galeria_23.webp', 'Tratamiento nutrición',  'Tratamientos'),
  G('g24', 'lpk_galeria_24.webp', 'Color y mechas',         'Color'),
  G('g25', 'lpk_galeria_25.webp', 'Corte clásico',          'Corte'),
  G('g26', 'lpk_galeria_26.webp', 'Diamond Rose',           'Tratamientos'),
  G('g27', 'lpk_galeria_27.webp', 'Keratina profunda',      'Tratamientos'),
  G('g28', 'lpk_galeria_28.webp', 'Mechas balayage',        'Color'),
  G('g29', 'lpk_galeria_29.webp', 'Volumen y movimiento',   'Corte'),
  G('g30', 'lpk_galeria_30.webp', 'Tintado completo',       'Color'),
  G('g31', 'lpk_galeria_31.webp', 'Corte y estilo',         'Corte'),
  G('g32', 'lpk_galeria_32.webp', 'Técnica color',          'Color'),
  G('g33', 'lpk_galeria_33.webp', 'Resultado alisado',      'Tratamientos'),
  G('g34', 'lpk_galeria_34.webp', 'Highlights',             'Color'),
  G('g35', 'lpk_galeria_35.webp', 'Estilo definitivo',      'Corte'),
  G('g36', 'lpk_galeria_36.webp', 'Tonos rubios',           'Color'),
  G('g37', 'lpk_galeria_37.webp', 'Corte y peinado',        'Corte'),
  G('g38', 'lpk_galeria_38.webp', 'Tratamiento brillo',     'Tratamientos'),
  G('g39', 'lpk_galeria_39.webp', 'Mechas finas',           'Color'),
  G('g40', 'lpk_galeria_40.webp', 'Resultado natural',      'Corte'),
  G('g41', 'lpk_galeria_41.webp', 'Balayage caramelo',      'Color'),
  G('g42', 'lpk_galeria_42.webp', 'Corte bob liso',         'Corte'),
  G('g43', 'lpk_galeria_43.webp', 'Color vibrante',         'Color'),
  G('g44', 'lpk_galeria_44.webp', 'Estilo ondulado',        'Corte'),
  G('g45', 'lpk_galeria_45.webp', 'Nutrición capilar',      'Tratamientos'),
  G('g46', 'lpk_galeria_46.webp', 'Color luminoso',         'Color'),
  G('g47', 'lpk_galeria_47.webp', 'Corte moderno',          'Corte'),
  G('g48', 'lpk_galeria_48.webp', 'Balayage y forma',       'Color'),
  G('g49', 'lpk_galeria_49.webp', 'Hidratación y brillo',   'Tratamientos'),
  G('g50', 'lpk_galeria_50.webp', 'Corte en capas',         'Corte'),
  G('g51', 'lpk_galeria_51.webp', 'Babylights',             'Color'),
  G('g52', 'lpk_galeria_52.webp', 'Estilo clásico',         'Corte'),
  G('g53', 'lpk_galeria_53.webp', 'Color profundo',         'Color'),
  G('g54', 'lpk_galeria_54.webp', 'Tratamiento alisado',    'Tratamientos'),
  G('g55', 'lpk_galeria_55.webp', 'Corte y volumen',        'Corte'),
  G('g56', 'lpk_galeria_56.webp', 'Mechas y color',         'Color'),
  G('g57', 'lpk_galeria_57.webp', 'Coloración completa',    'Color'),
  G('g58', 'lpk_galeria_58.webp', 'Corte definitivo',       'Corte'),
  G('g59', 'lpk_galeria_59.webp', 'Color y brillo',         'Color'),
  G('g60', 'lpk_galeria_60.webp', 'Hidratación shine',      'Tratamientos'),
  G('g61', 'lpk_galeria_61.webp', 'Corte limpio',           'Corte'),
  G('g62', 'lpk_galeria_62.webp', 'Tonos tierra',           'Color'),
  G('g63', 'lpk_galeria_63.webp', 'Balayage rubio',         'Color'),
  G('g64', 'lpk_galeria_64.webp', 'Tratamiento progresivo', 'Tratamientos'),
  G('g65', 'lpk_galeria_65.webp', 'Corte bob moderno',      'Corte'),
  G('g66', 'lpk_galeria_66.webp', 'Color y mechas',         'Color'),
  G('g67', 'lpk_galeria_67.webp', 'Estilo oscuro',          'Color'),
  G('g68', 'lpk_galeria_68.webp', 'Corte definido',         'Corte'),
  G('g69', 'lpk_galeria_69.webp', 'Nutrición y volumen',    'Tratamientos'),
  G('g70', 'lpk_galeria_70.webp', 'Coloración vibrante',    'Color'),
  G('g71', 'lpk_galeria_71.webp', 'Resultado impecable',    'Corte'),
  G('g72', 'lpk_galeria_72.webp', 'Estilo final',           'Corte'),
]
